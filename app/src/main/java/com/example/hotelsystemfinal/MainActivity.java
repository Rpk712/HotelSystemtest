package com.example.hotelsystemfinal;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.tv_Register: //注册
                Intent intent = new Intent(MainActivity.this, register.class);//跳转到注册界面
                        ...
                        Thread thread = new Thread(){
                            ...
                            public void run(){
                                try {
                                    ...
                                    Intent intent1 = new Intent(MainActivity.this, manage.class);//设置自己跳转到成功的界面
